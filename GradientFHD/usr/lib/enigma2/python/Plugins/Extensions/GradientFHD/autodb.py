...
class AutoDBStatusOSD(Screen):
    skin = """
        <screen name="AutoDBStatusOSD" position="10,10" size="980,40" backgroundColor="#80000000" flags="wfNoBorder" zPosition="999">
            <widget name="text" position="center,0" size="980,40" font="Regular;27" valign="center" halign="center" transparent="1" foregroundColor="#ffffff" borderWidth="1" borderColor="black" />
        </screen>
    """
...
class AutoDBInfoScreen(Screen):
    skin = """
	<screen name="AutoDBInfoScreen" position="center,center" size="1160,680" title="Information" flags="wfNoBorder" backgroundColor="transparent">
		...
		<ePixmap name="Line_Menu" position="center,375" size="1080,2" zPosition="10" pixmap="gfx/current/bg__1080x2_Line_Menu.png" alphatest="blend" />
		<ePixmap name="AutoDBManager_bg" position="0,0" size="1160,680" zPosition="-8" pixmap="gfx/current/bg___AutoDBManager_BG.png" alphatest="blend" />
		<widget name="text" position="20,70" size="1120,540" font="Regular;30" backgroundColor="gradient_background" halign="left" valign="top" transparent="1" />
	</screen>
    """
...
class AutoDBManager(Screen):
    skin = """
	<screen name="AutoDBManager" position="center,center" size="1160,680" title="AutoDB Manager (Poster + Backdrop)" flags="wfNoBorder" backgroundColor="transparent">
		<widget source="Title" render="Label" position="20,0" size="1060,60" font="Italic; 42" halign="left" valign="center" transparent="1" foregroundColor="gradient_foreground_selection" backgroundColor="background" borderColor="black" borderWidth="1" zPosition="1" />
		<ePixmap name="AutoDBManager_bg" position="0,0" size="1160,680" zPosition="-8" pixmap="gfx/current/bg___AutoDBManager_BG.png" alphatest="blend" />
